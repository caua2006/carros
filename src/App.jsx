   ...
   <main className='min-h-svh bg-offwhitebg px-6 py-20 antialiased lg:flex justify-center items-center'>
      <section className='lg:flex max-w-[920px]'>
        ...
        <div className='bg-green p-12'>
          ...
          <p className='font-lexend mb-7 text-offwhite text-sm lg:mb-20'>Escolha um SUV pelo seu interior espaçoso, poder e versatilidade. Perfeito para passar as férias em família ou para aventuras off-road.</p>
          <a className='font-lexend bg-offwhitebg text-green px-10 py-3 rounded-3xl block w-fit border-2 border-offwhitebg hover:bg-green hover:text-white' href="https://www.webmotors.com.br/suvs" target='_blank'>Ver mais</a>
        </div>

        <div className='bg-dark-green p-12 max-lg:rounded-b-lg lg:rounded-e-lg'>
